...
ActiveRecord::Schema.define(version: 20160402015403) do
  ...
  create_table "curatorxes", force: true do |t|
    t.string   "email",                  default: "", null: false
    t.string   "encrypted_password",     default: "", null: false
    t.string   "reset_password_token"
    t.datetime "reset_password_sent_at"
  ...
  add_index "curatorxes", ["email"], name: "index_curatorxes_on_email", unique: true, using: :btree
  add_index "curatorxes", ["reset_password_token"], name: "index_curatorxes_on_reset_password_token", unique: true, using: :btree
